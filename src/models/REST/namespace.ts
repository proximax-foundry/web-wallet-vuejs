...
export class NamespaceAPI {
  ...
  getLinkedAddress(namespaceId: NamespaceId): Promise<Address> {
    ...
    return this.namespaceHttp
      .getLinkedAddress(namespaceId, authHeader)
      .toPromise();
  }
  ...
  getLinkedMosaicId(namespaceId: NamespaceId): Promise<MosaicId> {
    const authHeader = RequestAuth.getAuthHeader();
    return this.namespaceHttp
      .getLinkedMosaicId(namespaceId, authHeader)
      .toPromise();
  }
  ...
  getNamespacesFromAccount(
    ...
    const authHeader = RequestAuth.getAuthHeader();
    return this.namespaceHttp
      .getNamespacesFromAccount(address, queryParams, authHeader)
      .toPromise();
  }
  ...
  getNamespacesFromAccounts(
    ...
    const authHeader = RequestAuth.getAuthHeader();
    return this.namespaceHttp
      .getNamespacesFromAccounts(addresses, queryParams, authHeader)
      .toPromise();
  }
  ...
  getNamespacesName(namespaceIds: NamespaceId[]): Promise<NamespaceName[]> {
    const authHeader = RequestAuth.getAuthHeader();
    return this.namespaceHttp
      .getNamespacesName(namespaceIds, authHeader)
      .toPromise();
  }
}
