  ...
  <div class='mt-2 py-3 gray-line text-center'>
    ...
    <transition tag="div" :name="slideDirection" mode="out-in">
          ...
          <div class="col-span-1 md:col-span-4 px-5 pt-5">
            ...
            <div class="text-left ml-3">
              <label class="inline-flex items-center">
                ...
                <span class="ml-2 cursor-pointer text-gray-500 text-sm">Send to Private Poll Index.</span>
              </label>
            </div>
        ...
        <div v-else-if="pageIndex==2" key="2" class="page">
            ...
            <div class="col-span-1 md:col-span-4 px-5">
              ...
              <div class="col-span-1 md:col-span-3">
                <label class="inline-flex items-center">
                  ...
                  <span class="ml-2 cursor-pointer text-gray-500 text-sm">Allow Multiple Response</span>
                </label>
              </div>
              <div class="rounded-2xl bg-gray-100 p-5 my-5" v-if="options.length > 0">
                <div class="text-tsm text-left">Option{{ (options.length>1?'s':'') }}</div>
              ...
              <div class="mt-3 text-center">
                <button class=" hover:shadow-lg bg-white hover:bg-gray-100 rounded-3xl border-2 font-bold px-6 py-2 border-blue-primary text-blue-primary outline-none focus:outline-none disabled:opacity-50 disabled:cursor-auto" @click="addOption" :disabled="disableAddOption">(+) Add Options</button>
              </div>
            </div>
            <div class="col-span-1 md:col-span-3">
              <div class="rounded-2xl bg-gray-100 p-5 my-5">
          ...
          <div class="mt-10">
            <button type="button" class="default-btn mr-5 focus:outline-none" @click="navigateTo(1);">Back</button>
            <button type="submit" class="default-btn py-1 disabled:opacity-50" :disabled="disableNextIndex2" @click="navigateTo(3)">Next</button>
          </div>
        </div>
        <div v-else-if="pageIndex==3" key="3" class="page">
          <div class="grid grid-cols-1 md:grid-cols-7">
            ...
            <div class="col-span-1 md:col-span-3">
              ...
              <div class="rounded-2xl bg-gray-100 p-5 my-5">
                <div class="inline-block mr-4 text-xs"><div class="text-tsm">Options List</div><div class="mt-2 text-tsm"><DisplayOptionModal :options="options" class="inline-block" /> | <a @click="navigateTo(2)" class="text-blue-primary font-bold">Edit</a></div></div>
              </div>
            </div>
          </div>
          <div class="mt-10">
            <button type="button" class="default-btn mr-5 focus:outline-none" @click="navigateTo(2)">Back</button>
            <button type="submit" class="default-btn py-1 disabled:opacity-50" :disabled="disableNextIndex3" @click="navigateTo(4)">Next</button>
          </div>
        </div>
        <div v-else-if="pageIndex==4" key="4" class="page">
            ...
            <div class="col-span-1 md:col-span-4 px-5">
              ...
              <div class="flex justify-between py-2 px-5 rounded-2xl bg-gray-100 mb-4 items-left">
                <div class="text-left w-full relative">
                  ...
                  <div class="font-bold mb-1">Poll Index Address:</div>
                  <input
                    id="pollIndexAddress"
          ...
          <div class="mt-10">
            <button type="button" class="default-btn mr-5 focus:outline-none" @click="navigateTo(3)">Back</button>
            <button type="submit" class="default-btn py-1 disabled:opacity-50" :disabled="disableNextIndex4" @click="createPoll(); navigateTo(1)">Create</button>
          </div>
        </div>
    </transition>
    </div>
