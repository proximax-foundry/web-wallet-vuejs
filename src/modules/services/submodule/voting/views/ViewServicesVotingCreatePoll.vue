<template>
  <div class="flex justify-between text-xs sm:text-sm">
    <div><span class="text-gray-400">{{$t('common.voting')}} ></span> <span class="text-blue-primary font-bold">{{$t('vote.createPoll')}}</span></div>
    <div>
    ...
    <div class="flex">
      <div class="flex-none">
        <div class="flex hover:bg-gray-200 p-0 sm:p-3 rounded-2xl cursor-pointer" @click="navigateTo(1)">
          ...
          <div class="inline-block self-center ml-3">{{$t('common.details')}}</div>
        </div>
      </div>
      ...
      <div class="flex-none">
        <div class="flex hover:bg-gray-200 p-0 sm:p-3 rounded-2xl cursor-pointer" @click="navigateTo(3)">
          ...
          <div class="inline-block self-center ml-3">{{$t('common.type')}}</div>
        </div>
      </div>
      <div class="h-1 bg-gray-200 flex-grow mx-2 self-center"></div>
      <div class="flex-none">
        <div class="flex hover:bg-gray-200 p-0 sm:p-3 rounded-2xl cursor-pointer" @click="navigateTo(4)">
          ...
          <div class="inline-block self-center ml-3">{{$t('common.activate')}}</div>
        </div>
      </div>
    </div>
    <div class="wrapper">
        ...
        <div v-if="pageIndex==1" key="1" class="page grid grid-cols-1 md:grid-cols-7">
          ...
          <div class="col-span-1 md:col-span-3">
            <div class="rounded-2xl bg-gray-100 p-5 my-5">
              <div class="inline-block text-center self-centerk <div>mHellr-4 text-xs"><img src="@/assets/img/icon-prx-xpx-blue.svg" class="w-5 inline mr-1 text-gray-500">{{$t('common.transactionFee')}}   XPX</div>
            </div>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-7">
            <div class="col-span-1 md:col-span-4 px-5">
              ...
              <div class="rounded-2xl bg-gray-100 p-5 my-5" v-if="options.length > 0">
                <div class="text-tsm text-left">{{$t('common.option',1)}}{{ (options.length>1?'s':'') }}</div>
            ...
            <div class="col-span-1 md:col-span-3">
              <div class="rounded-2xl bg-gray-100 p-5 my-5">
                <div class="inline-block mr-4 text-xs"><img src="@/assets/img/icon-prx-xpx-blue.svg" class="w-5 inline mr-1 text-gray-500">{{$t('common.transactionFee')}}   XPX</div>
              </div>
            </div>
          </div>
          <div class="mt-10">
            <button type="button" class="default-btn mr-5 focus:outline-none" @click="navigateTo(1);">{{$t('common.back')}}</button>
            <button type="submit" class="default-btn py-1 disabled:opacity-50" :disabled="disableNextIndex2" @click="navigateTo(3)">{{$t('common.next')}}</button>
          </div>
        </div>
        <div v-else-if="pageIndex==3" key="3" class="page">
          <div class="grid grid-cols-1 md:grid-cols-7">
            ...
            <div class="col-span-1 md:col-span-3">
              ...
              <div class="rounded-2xl bg-gray-100 p-5 my-5">
                <div class="inline-block mr-4 text-xs"><div class="text-tsm">{{$t('vote.optionsList')}}</div><div class="mt-2 text-tsm"><DisplayOptionModal :options="options" class="inline-block" /> | <a @click="navigateTo(2)" class="text-blue-primary font-bold">{{$t('common.edit')}}</a></div></div>
              </div>
            </div>
          </div>
          <div class="mt-10">
            <button type="button" class="default-btn mr-5 focus:outline-none" @click="navigateTo(2)">{{$t('common.back')}}</button>
            <button type="submit" class="default-btn py-1 disabled:opacity-50" :disabled="disableNextIndex3" @click="navigateTo(4)">{{$t('common.next')}}</button>
          </div>
        </div>
        <div v-else-if="pageIndex==4" key="4" class="page">
          <div class="grid grid-cols-1 md:grid-cols-7">
            ...
            <div class="col-span-1 md:col-span-3">
              ...
              <div class="rounded-2xl bg-gray-100 p-5 my-5">
                <div class="inline-block mr-4 text-xs"><div class="text-tsm">Options List</div><div class="mt-2 text-tsm"><DisplayOptionModal :options="options" class="inline-block" /> | <a @click="navigateTo(2)" class="text-blue-primary font-bold">{{$t('common.edit')}}</a></div></div>
              </div>
            </div>
          </div>
          <div class="mt-10">
            <button type="button" class="default-btn mr-5 focus:outline-none" @click="navigateTo(3)">{{$t('common.back')}}</button>
            <button type="submit" class="default-btn py-1 disabled:opacity-50" :disabled="disableNextIndex4" @click="createPoll(); navigateTo(1)">{{$t('common.create')}}</button>
          </div>
        </div>
    </transition>
    </div>
