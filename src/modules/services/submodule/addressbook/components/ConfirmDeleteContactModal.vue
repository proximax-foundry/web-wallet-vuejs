<template>
  <div>
    <div class="block hover:bg-gray-100 transition duration-200 p-2 z-20 cursor-pointer text-red-600"
      @click="openRemoveModal()">{{ $t('general.remove') }}</div>
      ...
      <div v-if="toggleModal" class="popup-outer fixed flex z-50">
        <div class="modal-popup-box">
          ...
          <div class="w-104 font-normal">
            <div class="error error_box" v-if="err != false">{{ err }}</div>
