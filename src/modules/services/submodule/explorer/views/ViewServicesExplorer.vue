<template>
  <div class="flex justify-between text-sm">
    <div><span class="text-gray-400">Transaction Explorer ></span> <span class="text-blue-primary font-bold">Explorer</span></div>
    <div>
  ...
  <div class='mt-2 py-3 gray-line pt-10 px-20'>
    <div class="grid xs:grid-cols-1 sm:grid-cols-7">
      ...
      <div class=" col-span-1 sm:col-span-7 md:col-span-1 my-5 sm:my-0 md:my-5 flex">
        <button class="default-btn py-1 flex-grow" @click="SearchTransaction()">Search</button>
      </div>
    </div>
    <DataTable
