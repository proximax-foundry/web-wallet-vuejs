<template>
  <div :class="disabled?'opacity-50':''">
    <div class="border border-gray-200 px-2 py-1 h-14 rounded-md">
      ...
      <input :disabled="disabled" :value="modelValue" @input="validate" @keypress="validateKey" maxlength="1" min=0 :max="max" :placeholder="placeholder" class="number_input" @click="clickInputText()" @focus="$event.target.select()">
    </div>
