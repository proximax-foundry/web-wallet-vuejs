<template>
  <div class="flex justify-between text-md">
    <div><span class="text-gray-300">{{$t('common.assets')}} ></span> <span class="text-blue-primary font-bold">{{$t('services.linkToNamespace')}}</span></div>
    <div>
        ...
        <fieldset class="w-full">
          ...
          <div class="text-left p-3 pb-0 border-l-8 border-gray-100 mb-5">
            <div class="bg-gray-100 rounded-2xl p-3">
              <div class="inline-block mr-4 text-tsm"><img src="@/assets/img/icon-prx-xpx-blue.svg" class="w-5 inline mr-1">{{$t('common.balance')}}: <span class="text-xs">{{ appStore.getBalanceByAddress(selectedAccAdd) }} XPX</span></div>
            </div>
          </div>
