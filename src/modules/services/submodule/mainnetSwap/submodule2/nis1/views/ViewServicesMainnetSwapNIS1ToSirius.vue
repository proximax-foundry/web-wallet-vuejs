  ...
  <div class='mt-2 py-3 gray-line px-0 lg:px-10 xl:px-80'>
    <div class="flex">
      ...
      <div class="flex-none">
        <div class="flex hover:bg-gray-200 p-0 sm:p-3 rounded-2xl cursor-pointer">
          ...
          <div class="inline-block self-center ml-3 text-xs sm:text-sm">{{$t('common.transaction',1)}}</div>
        </div>
      </div>
      <div class="h-1 bg-gray-200 flex-grow mx-2 self-center"></div>
      <div class="flex-none">
    ...
    <div v-if="currentPage==1">
      ...
      <div class="mb-2 flex justify-between bg-gray-100 rounded-2xl p-3 text-left cursor-pointer hover:bg-blue-100 transition" @click="selectAccount">
        <div class="text-tsm ml-3 text-gray-700">
          <div><b>{{$t('common.accountName')}}:</b> [[accountName]]</div>
    ...
    <div v-if="currentPage==2">
      ...
      <div class="mb-2 flex justify-between bg-gray-100 rounded-2xl p-3 text-left">
        ...
        <div class="self-center">
          <button @click="currentPage=1" class="hover:shadow-lg bg-white hover:bg-gray-100 rounded-3xl border-2 font-bold px-6 py-1 border-blue-primary text-blue-primary outline-none focus:outline-none">{{$t('common.change')}}</button>
        </div>
      </div>
    ...
    <div v-if="currentPage==3">
      <div>
        ...
        <div class="mt-10">
          <button type="button" class="hover:shadow-lg bg-white hover:bg-gray-100 rounded-3xl border-2 font-bold px-6 py-2 border-blue-primary text-blue-primary outline-none mr-4 w-32">{{$t('common.save')}}</button>
          <button type="button" class="default-btn mr-5 focus:outline-none disabled:opacity-50 w-32" :disabled="!savedCheck" >{{$t('common.done')}}</button>
        </div>
      </div>
    </div>
  </div>
