  ...
  <div>
    <div class='lg:w-9/12 ml-2 mr-2 lg:ml-auto lg:mr-auto mt-5'>
      <div class='mt-6 p-6 border filter shadow-lg text-center'>
        ...
        <div class="text-xs my-3 mb-5 sm:mb-10"><img src="@/modules/services/submodule/mainnetSwap/img/eth.svg" class="mr-2 h-5 inline-block">Check swap from ETH to Proximax Sirius Chain</div>
              ...
              <div class="flex-grow text-left text-xs md:text-sm ml-3 self-center transition-all duration-500" :class="step4?'text-gray-700':'text-gray-300'">
                ...
                <div v-if="isInitiateSwap">
                  <div class="sm:flex justify-between">
                    <div class="w-full">
                      <SelectInputAccount v-model="siriusAddressSelected" placeholder="To Sirius Chain Account" :selectDefault="walletState.currentLoggedInWallet?.selectDefaultAccount()?.address as string" />
                    </div>
        ...
        <div v-if="currentPage==3">
          <div>
            ...
            <swap-certificate-component networkTerm="ETH" swapType="In" :swapId="swapId" :swapTimestamp="swapTimestamp" :transactionHash="transactionHash" :siriusName="siriusAddressSelectedName" :swappedAmount="amount" :siriusAddress="Helper.createAddress(siriusAddressSelected as string).pretty()" :swapQr="swapQr" :swapLink="remoteTxnLink" />
...
import type { Account } from "@/models/account";
    ...
    const swapServerUrl = SwapUtils.getIncoming_ETHSwapTransfer_URL(swapData.swap_IN_SERVICE_URL, tokenName.value);
