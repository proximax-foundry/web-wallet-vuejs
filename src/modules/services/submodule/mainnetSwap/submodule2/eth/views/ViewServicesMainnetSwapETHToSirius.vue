      ...
      <div class='mt-6 p-6 border filter shadow-lg text-center'>
        ...
        <div v-if="currentPage==3">
          <div>
            ...
            <swap-certificate-component networkTerm="ETH" swapType="In" :swapId="swapId" :swapTimestamp="swapTimestamp" :transactionHash="transactionHash" :siriusName="siriusName" :swappedAmount="amount" :siriusAddress="Helper.createAddress(siriusAddress).pretty()" :swapQr="swapQr" :swapLink="validationLink" />
