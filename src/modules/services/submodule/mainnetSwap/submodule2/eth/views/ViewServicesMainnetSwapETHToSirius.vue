  ...
  <div class='mt-2 py-3 gray-line px-0 lg:px-10 xl:px-80'>
    ...
    <div v-if="currentPage==3">
      <div>
        ...
        <swap-certificate-component networkTerm="ETH" swapType="In" :swapId="swapId" :swapTimestamp="swapTimestamp" :transactionHash="transactionHash" :siriusAddress="siriusAddress" :swapQr="swapQr" />
