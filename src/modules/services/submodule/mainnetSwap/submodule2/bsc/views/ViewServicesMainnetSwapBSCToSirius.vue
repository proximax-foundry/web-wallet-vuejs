<template>
  <div class="flex justify-between text-xs sm:text-sm">
    <div><span class="text-gray-400">{{$t('swap.swap')}} > {{$t('services.bsc')}} > {{$t('swap.income')}} ></span> <span class="text-blue-primary font-bold">{{$t('swap.transaction')}}</span></div>
    <div>
  ...
  <div class='mt-2 py-3 gray-line px-0 lg:px-10 xl:px-80'>
    ...
    <div v-if="currentPage==3">
      <div>
        ...
        <swap-certificate-component networkTerm="BSC" swapType="Income" />
