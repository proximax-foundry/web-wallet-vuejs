<template>
  <div class="flex justify-between text-sm">
    <div><span class="text-gray-400">Mainnet Swap ></span> <span class="text-gray-400">Sirius to BSC ></span> <span class="text-blue-primary font-bold">Accounts List</span></div>
    <div>
  ...
  <div class='mt-2 py-3 gray-line px-0 lg:px-10 xl:px-80' v-if="currentPage==2">
    ...
    <div class="rounded-2xl bg-gray-100 p-5 mb-5">
      <div class="inline-block mr-4 text-xs"><img src="@/assets/img/icon-prx-xpx-blue.svg" class="w-5 inline mr-1 text-gray-500">Transaction Fee: BNB 0.051000 &#8776; XPX 0.051000 &#8776; USD 0.08</div>
    </div>
  ...
  <div class='mt-2 py-3 gray-line px-0 lg:px-10 xl:px-60 2xl-80' v-if="currentPage==3">
    <div>
      ...
      <swap-certificate-component networkTerm="BSC" />
      <div class="flex justify-between p-4 rounded-xl bg-white border-yellow-500 border-2 my-8">
        <div class="text-center w-full">
          <div class="w-8 h-8 inline-block relative">
            <div class="rounded-full border border-yellow-500 w-7 h-7 relative">
