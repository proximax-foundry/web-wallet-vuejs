<template>
  <div>
    ...
    <div class="float-right text-gray-600 text-xs mr-3 my-2" v-if="isShowRemark==true && remarkOption">Maximum amount after deducting transaction fee <b>[[transaction fee]] xpx</b> and gas fee <b>[[gas fee]]xpx</b></div>
  </div>
</template>
