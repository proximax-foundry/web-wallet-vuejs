...
const props = defineProps({
    ...
    lockFundCurrency: String || null || Number,
    lockFundTxFee: Number || null,
    totalFeeFormatted: String,
    selectedAccAdd: String,
    balance: String,
    sendXPX: String || null,
    getMultiSigCosigner: Object || null,
    checkCosignBalance: String || null,
    selectedMosaic: Object || null,
    mosaicsCreated: Object || null,
    assetRentalFeeCurrency: String || null,
    namespaceRentalFeeCurrency: String || null,
    fundStatus: Boolean || null,
    isMultisig: Boolean || null,
    isCosigner: Boolean ||null,
    onPartial: Boolean || null,
    isMultisigAlready: Boolean || null,
    lockFundCurrencyConvert: String || null || Number,
    lockFundTxFeeConvert: Number || null,
})
