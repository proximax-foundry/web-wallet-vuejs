    ...
    <div>
        <div class="lg:w-9/12 ml-2 mr-2 lg:ml-auto lg:mr-auto mt-5">
            ...
            <div class='border-2 border-t-0 '>
                ...
                <DataTable :value="assetMetadata" :paginator="true" :rows="10" dataKey="id"
                    ...
                    <Column field="action" header="Action" style="`wideScreen?'min-width: 180px'?'width: 180px'`">
                        <template #body="{ data }">
                            <router-link
                                :to="{ name: 'ViewUpdateAssetMetadata', params: { targetId: assetId, scopedMetadataKey: data.scopedMetadataKeyUtf8 ? data.scopedMetadataKeyUtf8 : data.scopedMetadataKeyHex } }">
                ...
                <router-link :to="{ name: 'ViewUpdateAssetMetadata', params: { targetId: assetId } }"><button
                        class="mx-6 my-4 blue-btn py-3 px-3 flex items-center"><img src="@/assets/img/icon-plus.svg"
                            class="inline-block w-4 h-4 mr-2">Create New Asset Metadata</button></router-link>
            </div>
        </div>
    </div>
</template>
...
const assetMetadata = ref<{ scopedMetadataKeyUtf8: string | null, scopedMetadataKeyHex: string, value: string }[]>([])
const publicKey = ref('')
