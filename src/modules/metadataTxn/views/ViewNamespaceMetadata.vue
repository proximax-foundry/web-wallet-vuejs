    ...
    <div class='border-2 border-t-0 '>
        ...
        >
            ...
            <Column field="action" header="Action"  style="`wideScreen?'min-width: 180px'?'width: 180px'`" >
                <template #body="{data}">
                    <router-link :to="{name: 'ViewUpdateNamespaceMetadata',params:{targetId:namespaceId,scopedMetadataKey:data.scopedMetadataKeyUtf8?data.scopedMetadataKeyUtf8:data.scopedMetadataKeyHex}}">
        ...
        <router-link :to="{name: 'ViewUpdateNamespaceMetadata',params:{targetId:namespaceId}}"><button  class="mx-6 my-4 blue-btn py-3 px-3 flex items-center" ><img src="@/assets/img/icon-plus.svg" class="inline-block w-4 h-4 mr-2">Create New Namespace Metadata</button></router-link>
    </div>
    </div>
  </div>
