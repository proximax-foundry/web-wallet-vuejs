  ...
  <div>
    <div class='w-10/12 ml-auto mr-auto'>
      <div class="border filter shadow-lg xl:grid xl:grid-cols-3 mt-8">
        ...
        <div class="bg-navy-primary py-6 px-12 xl:px-6 xl:col-span-1">
...
let targetAsset: MosaicId | null = null;
...
const fetchExistingKeys = () => {
  ...
  metadataQueryParams.targetId = targetAsset as MosaicId
...
const loadCurrentMetadataValue = async () => {
  if (targetAsset && scopedMetadataKeyHex.value && AppState.chainAPI) {
...
const updateMetadata = () => {
  ...
  let mosaicMetadataTransaction = txnBuilder
    ...
    .targetMosaicId(targetAsset as MosaicId)
  ...
  let aggregateTx = targetAccIsMultisig.value ?
    aggregateTxnBuilder.innerTransactions([mosaicMetadataTransaction.toAggregate(targetPublicAccount.value as PublicAccount)]).build() :
    AppState.buildTxn.aggregateCompleteBuilder().innerTransactions([mosaicMetadataTransaction.toAggregate(targetPublicAccount.value as PublicAccount)]).build()
