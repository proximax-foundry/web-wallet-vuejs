...
export default { 
  ...
  watch(scopedMetadataKeyType,n=>{
    ...
    const generateQr = () =>{
      ...
      let namespaceMetadataTransaction :AggregateBondedTransactionBuilder | AggregateCompleteTransactionBuilder
      ...
      namespaceMetadataTransaction = AppState.buildTxn.aggregateCompleteBuilder().innerTransactions([innerTxn])
      if(targetAccIsMultisig.value){
        namespaceMetadataTransaction = AppState.buildTxn.aggregateBondedBuilder().innerTransactions([innerTxn])
      }
    ...
    const updateMetadata = () => {   
      ...
      aggregateTxnBuilder.innerTransactions([namespaceMetadataTransaction.toAggregate(targetPublicAccount.value)]).build():
      AppState.buildTxn.aggregateCompleteBuilder().innerTransactions([namespaceMetadataTransaction.toAggregate(targetPublicAccount.value)]).build()
