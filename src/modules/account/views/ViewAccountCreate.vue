  ...
  <div>
    ...
    <div class='border w-8/12 ml-auto mr-auto mt-6 filter shadow-lg'>
      ...
      <div class="w-8/12 ml-auto mr-auto mt-3">
        <TextInput :placeholder="$t('account.namePlaceholder')" :errorMessage="$t('account.enterAccountName')"
          v-model="accountName" icon="wallet" />
      ...
      <div class="flex justify-center">
        <button type="submit" class="mt-3 blue-btn py-2 px-8 disabled:opacity-50" @click='create()'
