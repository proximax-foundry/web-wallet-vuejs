      ...
      <div v-if="toggleModal" class="popup-outer absolute flex z-50">
        ...
        <div class="modal-popup-box">
          ...
          <div class="w-104" v-if="!naviPrivateKey">
            <h1 class="default-title font-bold my-5">Select Account Type</h1>
            <div class="page-title-gray-line grid grid-cols-1 md:grid-cols-2 pt-20">
              ...
              <div class="px-5 self-center text-center my-10">
                ...
                <button class="max-w-xs sm:max-w-sm inline-block default-btn my-3 self-center" @click="naviPrivateKey = !naviPrivateKey">Select</button>
              </div>
            </div>
          </div>
          <div class="w-104" v-else>
            <h1 class="default-title font-bold my-5">From Private Key</h1>
            <div class="page-title-gray-line pt-20">
              <div class="my-5">Please fill in the private key of the linking account.</div>
              ...
              <div class="mt-10">
                ...
                <button type="submit" class="default-btn py-1 disabled:opacity-50 disabled:cursor-auto" :disabled="disableConfirm" @click="linkPrivateKey()">Confirm</button>
              </div>
            </div>
          </div>
        </div>
