...
<div class = 'flex text-xs font-semibold border-b-2 menu_title_div'>
    ...
    <router-link :class="`${selected=='collectibles'?'border-b-2 pb-3 border-yellow-500':''}`" v-if="!isDelegate()" :to="{name:'ViewAccountCollectibles', params: { address: address}}" class= 'w-28 text-center'>Collectibles</router-link>
