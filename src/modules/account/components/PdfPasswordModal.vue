<template>
  <div class=" blue-btn cursor-pointer py-3 px-4 text-center" @click="toggleModal = !toggleModal">
    {{ $t('general.downloadPaperWallet') }}</div>
  <transition enter-active-class="animate__animated animate__fadeInDown"
    ...
    <div v-if="toggleModal" class="popup-outer-lang fixed flex z-50">
      <div class="modal-popup-box ">
        ...
        <div @click="verifyWalletPwWalletPaper()"
          ...
          :disabled="disableDownload">{{ $t('general.confirm') }}</div>
        <div class='text-center cursor-pointer text-xs text-blue-link mt-2 font-semibold'
