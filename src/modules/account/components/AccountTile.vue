          ...
          <div class="relative inline-block text-left" @mouseover="hoverOverMenu" @mouseout="hoverOutMenu">
            ...
            <div :class="showMenuCall?'':'hidden'" class="absolute right-0 w-28 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-50" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
              <div class="py-1" role="none">
                ...
                <router-link :to="{ name: 'ViewAccountDisplayAll'}" class="block px-2 py-1 text-xs text-gray-700 hover:bg-blue-primary hover:text-white" role="menuitem" >Restrictions</router-link>
                <router-link :to="{ name: 'ViewAccountDisplayAll'}" class="block px-2 py-1 text-xs text-gray-700 hover:bg-blue-primary hover:text-white" role="menuitem" >Metadata</router-link>
                <router-link :to="{ name: 'ViewAccountDisplayAll'}" class="block px-2 py-1 text-xs text-gray-700 hover:bg-blue-primary hover:text-white" role="menuitem" >Delegate</router-link>
                <router-link :to="{ name: 'ViewAccountDisplayAll'}" class="block px-2 py-1 text-xs text-gray-700 hover:bg-blue-primary hover:text-white" role="menuitem" >Link to Namespace</router-link>
              </div>
            </div>
          </div>
        </div>
