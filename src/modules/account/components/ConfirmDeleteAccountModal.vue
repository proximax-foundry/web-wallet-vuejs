          ...
          <div class="w-104">
            ...
            <fieldset class="w-full">
              ...
              <div>
                ...
                <button type="submit" class="default-btn py-1 disabled:opacity-50" @click="deleteAccount();" :disabled="disableDelete">{{$t('common.delete')}}</button>
              </div>
            </fieldset>
          </div>
        </div>
  ...
  setup(p){
    ...
    const deleteAccount = () => {
      ...
      if(accountIndex > -1){
        ...
        err.value = t('accounts.removeAccountFail');
      }
    };
