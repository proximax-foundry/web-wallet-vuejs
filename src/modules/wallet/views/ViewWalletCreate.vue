  ...
  <div>
    <div v-if="!newWallet" class="container mx-auto md:grid md:grid-cols-2 md:mt-10 lg:px-20 xl:px-40  gap-4">
      ...
      <div class="md:col-span-1 bg-white mx-5 md:mx-0 px-30 pt-1 md:pt-0 rounded-md">
        <router-link v-if="!newWallet" :to="{ name: 'ViewWalletCreateSelection' }"
          class="text-xs m-2 text-blue-link items-center flex"><img src="@/assets/img/chevron_left.svg"
            class="w-5 inline-block">Back</router-link>
        <form @submit.prevent="createWallet">
          ...
          <div class="w-8/12 ml-auto mr-auto mt-3">
            <TextInput :placeholder="$t('wallet.namePlaceholder')" :errorMessage="$t('wallet.nameErrMsg')"
          ...
          <div class="text-center  text-xs text-blue-link font-semibold"><router-link :to="{ name: 'Home' }">{{
    ...
    <div v-else class="mr-auto ml-auto w-8/12 mt-3">
      ...
      <div class='border-2 shadow-lg filter mb-10 bg-white'>
        <div class='flex items-center'>
          ...
          <div class='flex flex-col justify-center ml-4'>
            ...
            <div class='flex'>
              <div id="address" :copyValue="address" copySubject="Address"
                class='text-xs font-semibold mt-1 w-36 truncate md:w-auto'>{{ address }} </div>
      ...
      <div class="border p-6 bg-white">
        ...
        <div class='flex'>
          <div id="public" class="text-xs font-semibold mt-1 break-all w-44 truncate md:w-auto" :copyValue="publicKey"
        ...
        <div>
          ...
          <div class='flex '>
            <div v-if="!toggleModal" class='break-all font-semibold w-44 truncate md:w-auto'>
              ****************************************************************</div>
          ...
          <div class='flex'>
            <div id="private" class="text-xs mt-1 font-semibold break-all w-44 truncate md:w-auto" type="text"
              :copyValue="privateKey" :copySubject="$t('general.privateKey')" v-if="toggleModal">{{ privateKey }}</div>
...
const err = ref("");
const newWallet = ref<null | WalletAccount>(null);
