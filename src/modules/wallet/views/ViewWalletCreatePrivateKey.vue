    ...
    >
      ...
      <div class="mx-auto page-title-gray-line pt-15">
        ...
        <div class="w-10/12 lg:w-8/12 self-center inline-block">
          ...
          <PasswordInput :placeholder="$t('common.privateKey')" :errorMessage="$t('common.invalidPrivateKey')" icon="key" v-model="privateKeyInput" class="ml-1" />
