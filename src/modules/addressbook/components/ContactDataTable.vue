...
import ConfirmDeleteContactModal from '@/modules/addressbook/components/ConfirmDeleteContactModal.vue';
import EditContactModal from '@/modules/addressbook/components/EditContactModal.vue';
