  ...
  <div class="flex flex-col" @mouseover="hoverOverNavigation" @mouseout="hoverOutNavigation">
   ...
   <!--  <div class="border-b border-gray-700 py-5 w-60 flex-grow-0">
    ...
    <div class="border-b border-gray-700 py-5 w-60 flex-grow-0">
      ...
      <router-link :to="{ name : 'ViewWalletConnect'}" class="link_block flex items-center text-white" @click="closeNavi"><img src="@/assets/img/navi/icon-swap.svg" class="h-3 w-3 inline-block relative mr-2">Wallet-connect</router-link>
