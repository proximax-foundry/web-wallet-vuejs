<template>
  <div class="relative text-center">
    ...
    <nav class="navbar" ref="navbarRef" v-if="showMenu">
      ...
      <router-link class="col" class-active="active" to="/services" :class="{'router-link-active': subIsActive(['/export-wallet', '/wallets', '/create-mosaic', '/add-contacts', '/delete-wallet-confirmed'])}">Services</router-link>
    </nav>
