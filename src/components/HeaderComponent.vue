<template>
  ...
  >
    ...
    <div class=" flex items-center gap-2">
      <div class="hidden lg:flex w-16 flex-row items-center left-gray-line relative">
        ...
        <div class="absolute z-20 w-96 text-left bg-gray-50 shadow-sm rounded-md right-0 p-2 text-tsm transition duration-200 block" style="top: 60px" v-if="isShowSupport" @mouseover="isShowSupport=true;isHoverSupportPanel=true;" @mouseout="hideSupportPanel">
          ...
          <div class="grid grid-cols-2">
            <div>
              <div class="p-2">
                <a class="mb-2 block text-blue-primary" href="https://bcdocs.xpxsirius.io/" target=_new>{{$t('home.gettingStarted')}}<img src="@/assets/img/icon-open_in_new.svg" class="inline-block -top-1 ml-1.5"></a>
                <div class="text-txs h-10">{{$t('home.allInfo')}}</div>
              </div>
              <div class="p-2">
                <a class="mb-2 block text-blue-primary" href="https://bcdocs.xpxsirius.io/docs/getting-started/what-is-proximax-sirius-chain/" target=_new>{{$t('home.siriusChain')}}<img src="@/assets/img/icon-open_in_new.svg" class="inline-block -top-1 ml-1.5"></a>
                <div class="text-txs h-10">{{$t('home.siriusChainTitle')}}</div>
              </div>
            </div>
            <div>
              <div class="p-2">
                <a class="mb-2 block text-blue-primary" href="https://bcdocs.xpxsirius.io/docs/built-in-features/namespace/" target=_new>{{$t('general.namespaceQues')}}<img src="@/assets/img/icon-open_in_new.svg" class="inline-block -top-1 ml-1.5"></a>
                <div class="text-txs h-10">{{$t('home.namespaceAns')}}</div>
              </div>
              <div class="p-2">
                <a class="mb-2 block text-blue-primary" href="https://bcdocs.xpxsirius.io/docs/built-in-features/mosaic/" target=_new>{{$t('general.assetQues')}}<img src="@/assets/img/icon-open_in_new.svg" class="inline-block -top-1 ml-1.5"></a>
      ...
      <div
        class="hidden pl-3 text-center lg:flex items-center left-gray-line"
      >
          <img
          ...
          />
          <div
            class="text-txs text-white text-left lg:ml-2"
          >
