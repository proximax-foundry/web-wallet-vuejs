  ...
  <div :class="disabled ? 'opacity-50' : ''">
    <div class="border border-gray-200 px-2 py-2 text-left flex justify-between items-center">
      <div>
        ...
        <input :type="inputType" :disabled="disabled == true" :value="modelValue" @input="updateValue" class="text_input"
    ...
    <div class="h-3 mb-2">
      <div class="error error-text text-left" v-if="pswdErr || showError">{{ errorMessage }}</div>
    </div>
  </div>
</template>
