            ...
            <div class="text-left md:justify-start md:flex md:items-stretch">
              <div class="block md:w-7/12 md:inline-block">
                ...
                <div class="relative"><span class="font-bold text-md mr-3">Transfer</span>
                  <img src="../../assets/img/arrow-transaction-receive-in-green-proximax-sirius-explorer.svg" class="w-7 h-7 inline-block absolute" style="top:-2px;" v-if="transaction.transferType=='in'">
  ...
  setup(p) {
    ...
    watch(() => p.showModal, () => {
      if(p.showModal){
        ...
        if(p.transaction.transferType=='in'){
          transferTypeIcon.value = '../../assets/img/arrow-transaction-receive-in-green-proximax-sirius-explorer.svg';
        }else{
          transferTypeIcon.value = '../../assets/img/arrow-transaction-sender-out-orange-proximax-sirius-explorer.svg';
        }
      }
    }, {immediate: true})
