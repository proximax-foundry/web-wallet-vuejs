    ...
    <div v-if="showPanel">
      <div style="max-height: 200px; overflow-y: scroll;" class="break-words p-2">
        <div class="subcontent">
          <div>
            <div class="text-green-600 font-bold" v-if="isReceived">Transaction Received&nbsp;&nbsp;<img src="../../assets/img/arrow-transaction-receive-in-green-proximax-sirius-explorer.svg" class="w-4 h-4 inline-block"></div>
            <div class="text-red-500 font-bold" v-else>Transaction Sent&nbsp;&nbsp;<img src="../../assets/img/arrow-transaction-sender-out-orange-proximax-sirius-explorer.svg" class="w-4 h-4 inline-block"></div>
          </div>
          <div>
            <div>Type:</div>
