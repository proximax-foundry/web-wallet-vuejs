<template>
  <div>
    <Dropdown v-model=selectedAccountInfo :style="{ 'width': '100%' }" :options=filteredAccounts :filter="true"
      optionLabel="label" emptyFilterMessage=" "
      ...
      <template #option="slotProps">
        <div class="account-item">
          <div class='flex'>
            <div v-html="convertImage(slotProps.options.value, 50, jdenticonConfig)" />
...
const convertImage = (address: string, size: number, config: JdenticonConfig) => {
