  ...
  <div @click='toggleSelection = !toggleSelection' class= "border ml-auto mr-auto py-3 px-2 cursor-pointer rounded-md">
    <div class='flex'>
      ...
      <div class='flex flex-col ml-2 text-left'>
        ...
        <div v-else class='text-tsm font-bold uppercase'>{{$t('general.selectAccount')}}</div>
      </div>
      <div v-if='!toggleSelection && selectedAccount==""' class='text-xxs ml-auto cursor-pointer text-blue-primary font-semibold mt-auto mb-auto'>{{$t('general.select')}}</div>
