<template>
  <div class= 'border w-8/12 ml-auto mr-auto py-3 px-2'>
    <div class='flex'>
        ...
        <img  v-if='toggleSelection' @click='toggleSelection = !toggleSelection; selectedWallet=""' src="@/assets/img/delete.svg" class='h-5 w-5 ml-auto cursor-pointer text-blue-primary font-semibold mt-auto mb-auto'>
    </div>
  </div>
