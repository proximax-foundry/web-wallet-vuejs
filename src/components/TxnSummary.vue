<template>
    <div v-if="selectedMultisigAddress">
        ...
        <div v-if="nativeAmount" class="lg:grid lg:grid-cols-5 grid grid-cols-7 justify-between items-center text-gray-200 text-xs pt-2">
        ...
        <div v-if="selectedAssets" class="lg:grid lg:grid-cols-5 grid grid-cols-7 text-white text-xs" v-for="(asset, index) in selectedAssets"
            :key="index">
    ...
    <div v-if="!selectedMultisigAddress">
        ...
        <div v-if="selectedAssets" class="lg:grid lg:grid-cols-5 grid grid-cols-7 text-white text-xs"
