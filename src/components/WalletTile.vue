<template>
  <div class='p-3'>
    <div class="bg-gray-200 rounded-2xl flex justify-between py-3">
      ...
      <div class="mr-5 self-center"><router-link :to="`/delete-wallet-confirmed/${wallet.name}`" class="hover:font-bold"><img src="../assets/img/icon-trash-can-gray-16h-proximax-sirius-wallet.svg" class="w-7 cursor-pointer"></router-link></div>
    </div>
  </div>
</template>
