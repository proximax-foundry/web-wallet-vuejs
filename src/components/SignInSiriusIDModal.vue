    ...
    >
      <div v-if="toggleModal" class="popup-outer absolute flex z-50">
        <div class="modal-popup-box">
          ...
          <img src="../assets/img/download.gif" class="inline-block w-40 mb-10 mt-6">
          <p>Don't have app? Download it from your store</p>
          <div class="flex justify-center my-3">
            <a href="https://apps.apple.com/us/app/proximax-siriusid/id1496615202" target=_new class="inline-block mr-2"><img src="../assets/img/app-store.png" class="w-32"></a>
            <a href="https://play.google.com/store/apps/details?id=io.proximax.siriusID" target=_new class="inline-block ml-2"><img src="../assets/img/google-play.png" class="w-32"></a>
          </div>
        </div>
      </div>
    </transition>
