<template>
  <div>
    <div class="bg-white py-2 border flex justify-between" >
      <input  :type="inputType" :disabled="disabled == true" :value="modelValue" @input="updateValue" class="w-full text-placeholder text-left ml-2" :placeholder="placeholder" @blur="blurInputPassword()" autocomplete="off">
