      ...
      <template #message="slotProps">
        <div style="width: 100%" class="grid grid-cols-12">
          ...
          <div class="col-span-12">
            ...
            <div :style="`font-size: ${slotProps.message.detail3RemSize ? slotProps.message.detail3RemSize : 0.7}rem`" v-if="slotProps.message.url">
              <a :href="slotProps.message.url" target="_blank">
              {{slotProps.message.detail3}}
              </a>
            </div>
            <div :style="`font-size: ${slotProps.message.detail3RemSize ? slotProps.message.detail3RemSize : 0.7}rem`" v-else>{{slotProps.message.detail3}}</div>
          </div> 
        </div>
      </template>
    </Toast>
