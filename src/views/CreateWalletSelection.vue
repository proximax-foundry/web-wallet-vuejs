    ...
    <h1 class="font-bold default-title mt-20">Select Wallet Creation Type</h1>
      <div class="page-title-gray-line grid grid-cols-1 md:grid-cols-3 pt-20">
        <div class="px-5 self-center text-center mb-10">
          <img src="/img/icon-add-new-blue.svg" class="w-12 inline-block">
        ...
        <div class="px-5 self-center text-center mb-10">
          <img src="/img/icon-private-key-blue.svg" class="w-12 inline-block"><p class="mt-3">From a Private Key</p>
        ...
        <div class="px-5 self-center text-center mb-10"><img src="/img/icon-wallet-import-blue.svg" class="w-12 inline-block"><p class="mt-3">From a Wallet Backup</p>
